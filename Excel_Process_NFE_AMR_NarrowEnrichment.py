...
output_file = f'C:\\Users\\boxx_\\Desktop\\gnomAD\\{file_path}\\NFE_AMR_{file_path}_NarrowEnrichment.xlsx'
...
B_frequency_column = 'Frequency Admixed American'    #
A_allele_count = 'Allele Count European (non-Finnish)'
B_allele_count = 'Allele Count Admixed American' #
...
B_to_A_frequency_ratio_column =  'Admixed Frequency/European non-Finnish Frequency'
B_to_C_frequency_ratio_column =  'Admixed Frequency/African African American Frequency'
